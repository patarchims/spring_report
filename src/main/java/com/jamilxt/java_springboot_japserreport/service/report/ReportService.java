...
public class ReportService {
    ...
    private void exportReportPasienRawatjalan(HttpServletResponse response, String noreg, String nama, String tglLahir, String norm, String jenisKelamin)throws JRException, IOException{
          ...
          AsesmentPasienModel asesmentPasienModel1 =  soapPasienRepository.findAsesmentByNoreg(noreg);
          ...
          parameters.put("c_keluhan_utama", asesmentPasienModel1.getKeluhan());
          parameters.put("c_riwayat_penyakit", asesmentPasienModel1.getRiwayatPenyakit());
          parameters.put("c_vital_darah", asesmentPasienModel1.getTekananDarah());
          parameters.put("c_vital_nadi", asesmentPasienModel1.getNadi());
          parameters.put("c_vital_suhu", asesmentPasienModel1.getSuhu());
          parameters.put("c_vital_pernapasan", asesmentPasienModel1.getPernapasan());
          parameters.put("c_nutrisi_bb", asesmentPasienModel1.getBeratBadan());
          parameters.put("c_nutrisi_tb", asesmentPasienModel1.getTinggiBadan());
